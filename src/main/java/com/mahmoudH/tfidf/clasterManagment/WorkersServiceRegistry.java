...
public class WorkersServiceRegistry implements Watcher {
    ...
    public WorkersServiceRegistry(ZooKeeper zooKeeper) {
    ...
    public void registerServiceToCluster(String address) throws KeeperException, InterruptedException {
        ...
        System.out.println("node: " + currentNode.replace(REGISTRY_PATH + "/", "") + " register successfully as worker");
    }
    ...
    void unregisterService() throws KeeperException, InterruptedException {
        if (currentNode != null&&zooKeeper.exists(currentNode, false) != null ){
            ...
            System.out.println("this node unregistered as worker");
        }
    }
